...
- Models: many repos do NOT auto-download model weights. Read each repo's README.
  Examples:
...
- Docker services:
    * qdrant: run with 'docker run -p 6333:6333 qdrant/qdrant' or use docker-compose.
