...
- **[R] DONE** - commit con pathspec. Leccion: detectores de flags mecanicos -> TOKEN ACTIVO con ventana de negacion, nunca substring bruto (falso positivo real en L1959 que detenia el bucle).
