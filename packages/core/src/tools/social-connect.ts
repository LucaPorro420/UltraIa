...
export const SOCIAL_NETWORKS: SocialNetwork[] = [
  ...
  { id: 'linkedin', nombre: 'LinkedIn', auth: 'oauth2', envVars: ['LINKEDIN_ACCESS_TOKEN', 'LINKEDIN_AUTHOR_URN'], loginUrl: 'https://developer.linkedin.com', scopes: ['w_member_social', 'rw_organization_admin'], publish: true, notas: 'Posts API vigente (/rest/posts + Assets registerUpload). UGC v2/ugcPosts es Legacy y ya no se usa. Author URN persona u organización.' },
