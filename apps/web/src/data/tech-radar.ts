// //! Respaldo tipado del radar tecnologico (espejo de la tabla TechRadar en SQLite).
// * La pagina /roadmap lee ESTE archivo (no hace consulta a la BD).
// * Para editar datos en la BD, corre: node packages/core/prisma/seed-tech-radar.mjs
export type TechRadarItem = {
  name: string;
  category: string;
  usagePercent: number; // peso aproximado en el codigo (no suma 100)
  importance: number; // 1 (bajo) .. 5 (critico)
  connections: string[]; // nombres de otras techs de las que depende
  improvements: string[]; // mejoras sugeridas (backlog)
  status: 'active' | 'planned' | 'deprecated';
  notes?: string;
};

export const TECH_RADAR: TechRadarItem[] = [
  {
    name: 'Next.js',
